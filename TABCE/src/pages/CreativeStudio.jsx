...
const CreativeStudio = () => {
    ...
    // Real-time makeup intensity update
    const updateMakeupIntensity = (property, value) => {
        setMakeupConfig(prev => ({
            ...prev,
    ...
    const updateMakeupColor = (property, color) => {
        setMakeupConfig(prev => ({
            ...prev,
            [property]: color
        }));
                    ...
                    <div className="makeup-workspace">
                        ...
                        <div className="makeup-controls">
                            ...
                            <div className="control-section">
                                ...
                                <div className="control-group">
                                    <label>Intensity: {makeupConfig.lipIntensity}%</label>
                                    <input
                                        type="range"
                                        min="0"
                                        max="100"
                            ...
                            <div className="control-section">
                                ...
                                <div className="control-group">
                                    <label>Intensity: {makeupConfig.blushIntensity}%</label>
                                    <input
                                        type="range"
                                        min="0"
                                        max="100"
                            ...
                            <div className="control-section">
                                ...
                                <div className="control-group">
                                    <label>Intensity: {makeupConfig.eyeshadowIntensity}%</label>
                                    <input
                                        type="range"
                                        min="0"
                                        max="100"
